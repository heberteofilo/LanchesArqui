...
namespace LanchesArqui.Areas.Admin.Controllers
{
    ...
    public class AdminPedidosController : Controller
    {
        ...
        public AdminPedidosController(AppDbContext context, CarrinhoCompra carrinhoCompra)
        {
            _context = context;
        ...
        {
            //inclui os pedidos detalhes depois os lanches cujos ids forem iguais ao pedido id
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,Endereco1,Endereco2,Cep,Estado,Cidade,Telefone,Email,PedidoTotal,PedidoEnviado,PedidoEntregueEm,TotalItensPedido")] Pedido pedido)
        {        
            if (id != pedido.Id)
            {
                return NotFound();
